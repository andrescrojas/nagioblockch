...
// Blockchain Transaction Contract v 1.0
...
type AssetState struct {
    ...
    Type         *string          `json:"type,omitempty"`           // asset type
    Acquirer     *string          `json:"acquirer,omitempty"`       // asset acquirer
    Acquirerbank *string          `json:"acquirerbank,omitempty"`   // asset acquirerbank
